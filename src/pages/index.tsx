    ...
    <Container>
      ...
      >
        ...
        <Form.Field error={touched && !isValid}>
          <label>Your WNYC wallet address</label>
          <Input
            disabled={loading}
            type="text"
            value={value}
        ...
        {success && (
          <Message
            success
            content="0.1 WNYC will soon be transferred to your wallet."
          />
        )}
      ...
      <p>
        Please send WNYC donations to{' '}
        {process.env.NEXT_PUBLIC_CONTRACT_ADDRESS} to keep this faucet running.
      </p>
      <h5>
        Developed &amp; maintained by{' '}
        <a href="https://cryptoloverbots.com" target="_blank">
          CryptoLover.
        </a>
      </h5>
      {contractBalance ? (
